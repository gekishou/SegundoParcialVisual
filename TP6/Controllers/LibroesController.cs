...
namespace TP6
{
    public class LibroesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdLibro,Autor,Titulo,Isbn,Lugar,Paginas,Edicion,Editorial,Fecha")] Libro libro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Titulo,Autor,Isbn,Lugar,Paginas,Edicion,Editorial,Fecha")] Libro libro)
        {
